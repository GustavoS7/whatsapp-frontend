...
export function WhatsappHome () {
  return (
    <div className="h-full w-full dark:bg-dark_bg_4 select-none border-l dark:border-l-dark_border_2 border-b-[6px]-green_2">
      <div className="-mt-1 5 w-full h-full flex flex-col gap-y-8 items-center justify-center">
        ...
        <p className="text-sm dark:text-dark_text_3 ">
          Send and receive messages without keeping yout phone online <br />
